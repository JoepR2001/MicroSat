...
def send_follow_joint_trajectory_action_goal(input_arm):
    ...
    point.positions = input_arm["q"]  # Replace with desired positions
    point.velocities = input_arm["v"]  # Replace with desired velocities
    point.accelerations = input_arm["a"]  # Replace with desired accelerations
    point.effort = input_arm["e"]  # Replace with desired effort
    point.time_from_start = rospy.Duration(input_arm["t"])  # Time to reach this point
